...
### 5 College Donations - Employees living in Amherst
...
ggplot(data = amherstcol_donations, aes(x = contribution_receipt_date, y = contribution_receipt_amount, color = committee_name)) + geom_point() + scale_color_manual(values = c( "#228b22","#add8e6", "#00008b", "#ffa500"))

mtholyoke_donations <- amherst_donations %>%
  filter(contributor_employer == "MOUNT HOLYOKE COLLEGE")

ggplot(data = mtholyoke_donations, aes(x = contribution_receipt_date, y = contribution_receipt_amount, color = committee_name)) + geom_point() + scale_color_manual(values = c("#add8e6", "#00008b", "#ffa500"))
...
ggplot(data = umass_donations, aes(x = contribution_receipt_date, y = contribution_receipt_amount, color = committee_name)) + geom_point()
```
